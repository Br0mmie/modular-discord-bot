...
const BOT_TOKEN = "NjY1NzM3MTM3NDMzNjA4MjIx.Xhq-DQ.mkhctA7gHiEh9E-S0ZKokOXPu9g" // bot's token
...
bot.on("message", function(message) { // when a message is sent
    ...
    if (command == "info") { // creates the command *info
        message.channel.send("Hey! My name is ModularDiscordBotto and I'm here to assist you! You can do *help to see all of my commands! If you have any problems with the Discord server, you can contact an administrator! :smile:") // gives u info
    }
    ...
    if (command == "date") {
    	...
    	message.channel.send(date + "/" + month + "/" + year);
    }
